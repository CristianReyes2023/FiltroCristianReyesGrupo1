CREATE DATABASE jardineriadbCristian;
USE jardineriadbCristian;
...
CREATE TABLE empleado (
  ...
  idOficinaFk VARCHAR(10) NOT NULL,
  idEmpleadoJefeFk INTEGER DEFAULT NULL,
  puesto VARCHAR(50) DEFAULT NULL,
  CONSTRAINT id PRIMARY KEY (id),
  CONSTRAINT idOficinaFk FOREIGN KEY (idOficinaFk) REFERENCES oficina (id),
  CONSTRAINT idEmpleadoJefeFk FOREIGN KEY (idEmpleadoJefeFk) REFERENCES empleado (id)
);
...
CREATE TABLE cliente (
  ...
  idEmpleadoRepresentanteVentasFk INTEGER DEFAULT NULL,
  limite_credito NUMERIC(15,2) DEFAULT NULL,
  CONSTRAINT id PRIMARY KEY (id),
  CONSTRAINT idEmpleadoRepresentanteVentasFk FOREIGN KEY (idEmpleadoRepresentanteVentasFk) REFERENCES empleado (id)
);
...
CREATE TABLE pedido (
  ...
  CONSTRAINT id PRIMARY KEY (id),
  CONSTRAINT idClienteFk FOREIGN KEY (idClienteFk) REFERENCES cliente (id)
);

CREATE TABLE producto (
  id VARCHAR(15) NOT NULL,
  nombre VARCHAR(70) NOT NULL,
  idGamaFk VARCHAR(50) NOT NULL,
  ...
  CONSTRAINT id PRIMARY KEY (id),
  CONSTRAINT idGamaFk FOREIGN KEY (idGamaFk) REFERENCES gama_producto (id)
);

CREATE TABLE detalle_pedido (
  idPedidoFk INTEGER NOT NULL,
  idProductoFk VARCHAR(15) NOT NULL,
  cantidad INTEGER NOT NULL,
  precio_unidad NUMERIC(15,2) NOT NULL,
  numero_linea SMALLINT NOT NULL,
  CONSTRAINT id PRIMARY KEY (idPedidoFk, idProductoFk),
  CONSTRAINT idPedidoFk FOREIGN KEY (idPedidoFk) REFERENCES pedido (id),
  CONSTRAINT idProductoFk FOREIGN KEY (idProductoFk) REFERENCES producto (id)
);
...
CREATE TABLE pago (
  ...
  CONSTRAINT id PRIMARY KEY (id),
  CONSTRAINT idClienteFkk FOREIGN KEY (idClienteFk) REFERENCES cliente (id)
);
